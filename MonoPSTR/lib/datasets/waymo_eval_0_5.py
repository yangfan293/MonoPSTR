...
class DetectionMetricsEstimatorTest(tf.test.TestCase):
    ...
    def get_boxes_from_txt(self, pd_set, gt_set, pd_dir, gt_dir):
        ...
        for i in range(len(pred_lines)): #39848
            ...
            gt_file_name = os.path.join("/data1/hx/DEVIANT/code/data/waymo/validation/label_2/",
                                        pred_file.split('/')[-1])
            ...
            for category in category_list:
                for level in level_list:
                    ...
                    for metric in metric_list:
                        ...
                        n+=1
                        #print('key0:',key0, 'aps[key0]:',aps[key0], 'aps[key0][0]:',aps[key0][0])
...
if __name__ == '__main__':
    ...
    pd_set = os.path.join(folder_path, 'ImageSets/val.txt')
    gt_set = "/data1/hx/DEVIANT/code/data/waymo/ImageSets/val_org.txt" #gt_set = os.path.join(folder_path, 'ImageSets/val_org.txt')
