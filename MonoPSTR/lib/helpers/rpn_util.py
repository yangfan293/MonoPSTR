...
#evaluate_nusc_kitti_results_verbose(results_folder= results_folder, conf= self.cfg,use_logging= True, logger= self.logger)
...
def evaluate_waymo_results_verbose(results_folder, conf= None, use_logging= False, logger= None):
    ...
    command_0_7      = path + " -u .../waymo_eval.py --predictions "     + results_folder + " --pd_set " + pd_set
    command_0_5      = path + " -u .../waymo_eval_0_5.py --predictions " + results_folder + " --pd_set " + pd_set
