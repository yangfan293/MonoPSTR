...
class Tester(object):
    def __init__(self, cfg, model, dataloader, logger, train_cfg=None, model_name='monopstr'):
        self.cfg = cfg
        self.model = model
    ...
    def evaluate(self):
        ...
        gt_folder = "/data1/hx/DEVIANT/code/data/waymo/validation/label"
        ...
        result = evaluate_waymo_results_verbose(results_folder=results_folder, conf=self.cfg, \
