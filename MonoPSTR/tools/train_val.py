...
parser = argparse.ArgumentParser(description='Monocular 3D Object Detection with Dynamic Position&Scale-aware Transformer')
...
def main():
    ...
    set_random_seed(cfg.get('random_seed', 222))
